class ProductivityStrengths {
	...
	render() {
		console.log('- Init ProductivityStrengths...')
		this.set_title()
		this.render_chart()
		console.log('- Init ProductivityStrengths [OK]')
	}
	...
	render_chart() {
		...
		.append("svg")
		.attr("class", "productivity_strengths_chart")
...
export default ProductivityStrengths
