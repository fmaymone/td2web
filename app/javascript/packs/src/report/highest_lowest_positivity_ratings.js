class HighestLowestPositivityRatings {
  ...
  render() {
    console.log('- Init HighestLowestPositivityRatings...')
    this.set_title()
    this.render_chart()
    console.log('- Init HighLowestPositivityRatings [OK]')
  }
  ...
  set_title() {
    ...
    try {
      ...
      console.log('ERROR! HighestLowestPositivityRatings chart container not found.')
      return(false)
    }
  ...
  create_tables(parent) {
    ...
    highestTable.setAttribute("id", "highest_positivity_rating_table")
    ...
    lowestTable.setAttribute("id", "lowest_positivity_rating_table")
  ...
  add_rows(data, column) {
    const table = document.getElementById(column + "_positivity_rating_table") 
    const table_body = table.createTBody()
    var background_color
    console.log(table)
    data.forEach((row, row_index) => {
      let table_row = table_body.insertRow()
      table_row.setAttribute("data-highestlowestcategory", column + "positivity")
...
export default HighestLowestPositivityRatings
