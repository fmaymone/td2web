...
module ReportServices
  module DataGenerators
    # Highest and Lowest Productivity Ratings
    class HighestLowestProductivityRatings < Base
      TITLE = 'Highest Lowest Productivity Ratings'
      ID = 'HighestLowestProductivityRatings'
      VERSION = 1
      ...
      def highest
        @highest ||= top_responses_by_category('Productivity', 'top', 5)
      end

      def lowest
        @lowest ||= top_responses_by_category('Productivity', 'bottom', 5)
      end
