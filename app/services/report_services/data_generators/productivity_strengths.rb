...
module ReportServices
  module DataGenerators
    # Productivity Strengths chart data generator
    class ProductivityStrengths < Base
      TITLE = 'Productivity Strengths Rating'
      ID = 'ProductivityStrengths'
      VERSION = 1
      ...
      def responses
        @responses ||= all_avg_factor_responses_by_category('Productivity')
      end
